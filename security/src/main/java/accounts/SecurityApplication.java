...
@Configuration
@ComponentScan
// TODO-03: Import the SecurityConfig class, Save all work and let the server restart.
// You should be able to access the home page,
// but you should see a 404 when clicking on "View account list" (we have no login page, yet).
